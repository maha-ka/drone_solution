...
class SimpleMover():
    ...
    def __init__(self):
        ...
        self.image_1 = np.zeros((10,10,3))
        self.image_2 = np.zeros((10,10,3))
    ...
    def spin(self):
        ...
        while not rospy.is_shutdown():
            try:
                ...
                k = 0.5
                b = 0.01
                zdot = (self.drone_state[2] - altitude_prev)/dt
                u_z = k*(self.z_des - self.drone_state[2]) - b*zdot
                ...
                ks = Kp_w
                bs = Kd_w
                u_omega_z = -ks*self.omega_error - bs*(-self.omega_error - omega_error_prev)/dt
                ...
                bo = Kd_y
                # u_y = 0
                u_y = ko*self.y_error - bo*(self.y_error - y_error_prev)/dt
